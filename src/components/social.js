const SocialMedia = () => {
    ...
    <ul>
        <li>
            <div className="icon">
                <a href="https://www.facebook.com/omaribbrahim" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-facebook" viewBox="0 0 16 16">
                    <path fillRule="evenodd" d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303
        ...
        <li>
            <div className="icon">
            <a href="https://www.twitter.com/omargfh1" target="_blank">
                ...
                3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344
                9.344 0 0 0 5.026 15z"></path>
                </svg>
            </a>
            </div>
        </li>
        <li>
        <div className="icon">
            <a href="https://www.instagram.com/omaribb_" target="_blank">
        ...
        <li>
            <div className="icon">
                <a href="https://github.com/omargfh" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-github" viewBox="0 0 16 16">
                    <path fillRule="evenodd" d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95
                    ...
                    1.93-.01 2.2 0 .21.15.46.55.38A8.012 8.012 0 0 0 16 8c0-4.42-3.58-8-8-8z"></path>
                    </svg>
                </a>
            </div>
        </li>
        <li>
            <div className="icon">
                <a href="https://www.linkedin.com/in/omar-ibrahim-185877186/" target="_blank">
        ...
        <li>
            <div className="icon">
                <a href="https://wa.me/+17739521030?text=Hey%20Omar%21%20%0AI%20have%20found%20you%20through%20your%20personal%20website%20and%20I%20wanted%20to%20connect%20with%20you.%20If%20you%20are%20free%2C%20please%20text%20me%20back%20as%20soon%20as%20possible.%20Thanks." target="_blank">
